  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edición de Modelo</h1>
          </div><!-- /.col -->
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <form action="<?=URL::to('admin/modelo_editar')?>" method="post">
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
					...
					<option selected value="<?php echo $data['modelo'][0]->marca_id; ?>"><?php echo $data['modelo'][0]->marca; ?></option>
                ...
                <div class="form-group">
					...
					<input type="text" class="form-control" name="modelo" value="<?php echo $data['modelo'][0]->modelo; ?>">
                </div>
                <div class="form-group">
                 	<br>
                    <input type="hidden" class="form-control" name="id" value="<?php echo $data['modelo'][0]->id; ?>">
                  	<button type="submit" class="btn btn-primary">Grabar Edición</button>
                    <a type="button" href="admin/modelos" class="btn btn-danger">Cancelar</a>
                </div>
              </div>
