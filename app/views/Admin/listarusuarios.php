        ...
        <div class="card">
		  <div class="card-body p-0">
			<table class="table table-striped">
			  ...
			  <tbody>
				<?php $x = 0; foreach($data['usuarios'] as $usuarios){ ?>
				<tr>
				  ...
				  <?php if($usuarios->estado=="1"){
					echo "<a href='".URL::to('admin/disableusuario?id='.$usuarios->id)."' class='btn btn-danger'>Desactivar</a>";
					}else{
					echo "<a href='".URL::to('admin/enableusuario?id='.$usuarios->id)."' class='btn btn-primary'>Activar</a>";}
					?>
                      <a href="<?=URL::to('admin/usuario_edit?id='.$usuarios->id); ?>" class='btn btn-success'>Editar</a>
                      <a href="<?=URL::to('admin/usuario_marcas?id='.$usuarios->id); ?>" class='btn btn-primary'>Marcas</a>
				  </td>
				  <td><?php if($usuarios->estado=="1"){echo "Activado";}else{echo "Desactivado";} ?></td>
				</tr>
				<?php } ?>
