  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Lista de Modelos</h1>
          </div><!-- /.col -->
        ...
        <div class="card">
		  <div class="card-body p-0">
			<table class="table table-striped">
			  ...
			  <tbody>
				<?php $x = 0; foreach($data['modelo'] as $modelo){ ?>
				<tr>
				  <td><?php echo $x=$x+1; ?></td>
				  <td><?php echo $modelo->marca; ?></td>
				  <td><?php echo $modelo->modelo; ?></td>
				  <td>
				  <?php if($modelo->estado=="1"){
					echo "<a href='".URL::to('admin/disablemodelo?id='.$modelo->id)."' class='btn btn-danger'>Desactivar</a>";
					}else{
					echo "<a href='".URL::to('admin/enablemodelo?id='.$modelo->id)."' class='btn btn-primary'>Activar</a>";}
					?>
                      <a href="<?=URL::to('admin/modelo_edit?id='.$modelo->id); ?>" class='btn btn-success'>Editar</a>
				  </td>
				  <td><?php if($modelo->estado=="1"){echo "Activado";}else{echo "Desactivado";} ?></td>
				</tr>
				<?php } ?>
